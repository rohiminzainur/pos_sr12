...
<body onload="window.print()">
    ...
    <p>No: {{ tambah_nol_didepan($sale->id, 10) }}</p>
    ...
    <table width="100%" style="border: 0;">
        ...
        <tr>
            <td>Total Paid:</td>
            <td class="text-right">{{ format_uang($sale->paid) }}</td>
        </tr>
        <tr>
            <td>Received:</td>
            <td class="text-right">{{ format_uang($sale->received) }}</td>
        </tr>
        <tr>
            <td>Back Money:</td>
            <td class="text-right">{{ format_uang($sale->received - $sale->paid) }}</td>
        </tr>
    </table>
    <p class="text-center">===================================</p>
